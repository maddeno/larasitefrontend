    ...
    render() {
        return (
            <Grid> 
                ...
                <Header as="h2">Honors and Awards:</Header>
                    <List>
                        <List.Item>
                    ...
                    <Header as='h2'>Summer Festivals:</Header>
                    <List>
                        <List.Item>
                ...
                <Grid.Column width={6}>
                    <Container text style={{ marginTop: '7em'}} floated="right">
                        <Header as='h2'>Orchestral Experience</Header>
                        <List>
                            <List.Item>
                        ...
                        <Header as='h2'>Teaching Experience</Header>
                        <List>
                            <List.Item>
                        ...
                        <Button color="black" onClick={() => this.props.toggle()}>Biography</Button>
                    </Container>
                </Grid.Column>               
                </Grid.Row>
            </Grid>
